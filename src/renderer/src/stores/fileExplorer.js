...
export const useFileExplorerStore = defineStore('fileExplorer', () => {
  // Folders table - compatible with: id, name, parent_id, order_index, created_at, updated_at
  const folders = ref([
    { id: 'list1', name: '01_Introduction', parentId: null, orderIndex: 0, createdAt: new Date('2024-01-01'), updatedAt: new Date('2024-01-01') },
    { id: 'list1-archived', name: 'archived', parentId: 'list1', orderIndex: 0, createdAt: new Date('2024-01-01'), updatedAt: new Date('2024-01-01') },
    { id: 'list2', name: '02_Getting_Started', parentId: null, orderIndex: 1, createdAt: new Date('2024-01-02'), updatedAt: new Date('2024-01-02') },
    { id: 'list3', name: '03_Core_Concepts', parentId: null, orderIndex: 2, createdAt: new Date('2024-01-03'), updatedAt: new Date('2024-01-03') },
    { id: 'list4', name: '04_Advanced_Topics', parentId: null, orderIndex: 3, createdAt: new Date('2024-01-04'), updatedAt: new Date('2024-01-04') },
    { id: 'list5', name: 'Module_1', parentId: null, orderIndex: 4, createdAt: new Date('2024-01-05'), updatedAt: new Date('2024-01-05') },
    { id: 'list6', name: 'Module_2', parentId: null, orderIndex: 5, createdAt: new Date('2024-01-06'), updatedAt: new Date('2024-01-06') },
    { id: 'list7', name: 'Module_3', parentId: null, orderIndex: 6, createdAt: new Date('2024-01-07'), updatedAt: new Date('2024-01-07') },
    { id: 'list8', name: 'Bonus_Content', parentId: null, orderIndex: 7, createdAt: new Date('2024-01-08'), updatedAt: new Date('2024-01-08') }
  ])

  // Files table - compatible with: id, name, folder_id, order_index, file_type, metadata, created_at, updated_at
  const files = ref([
  ...
  function createFolder(folderData) {
    ...
    const newFolder = {
      ...
      orderIndex: folderData.orderIndex ?? folders.value.filter(f => f.parentId === folderData.parentId).length,
      createdAt: now,
      updatedAt: now
    }
  ...
  function createFile(fileData) {
    ...
    const newFile = {
      ...
      orderIndex: fileData.orderIndex ?? files.value.filter(f => f.folderId === fileData.folderId).length,
