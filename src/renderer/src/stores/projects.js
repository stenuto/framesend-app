...
export const useProjectsStore = defineStore('projects', () => {
  ...
  const fileSystem = ref([
    ...
    { id: 'fs4', type: 'video', name: 'Campaign_Overview.mp4', parentId: null, projectId: 'proj1', orderIndex: 3, duration: '3:45', size: '450 MB' },
    ...
    // Videos in folders
    { id: 'fs9', type: 'video', name: 'CEO_Interview_Raw.mp4', parentId: 'fs5', projectId: 'proj1', orderIndex: 0, duration: '15:32', size: '1.2 GB' },
    { id: 'fs10', type: 'video', name: 'CTO_Interview_Raw.mp4', parentId: 'fs5', projectId: 'proj1', orderIndex: 1, duration: '12:18', size: '980 MB' },
    ...
    { id: 'fs13', type: 'video', name: 'Campaign_Final_1080p.mp4', parentId: 'fs7', projectId: 'proj1', orderIndex: 0, duration: '2:30', size: '180 MB' },
    { id: 'fs14', type: 'video', name: 'Campaign_Final_4K.mp4', parentId: 'fs7', projectId: 'proj1', orderIndex: 1, duration: '2:30', size: '680 MB' },
