  ...
  <div>
    ...
    <div v-else class="space-y-8 pt-8">
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-3">
            <div v-for="member in teamMembers" :key="member.id"
              class="flex items-center justify-between p-3 bg-zinc-50 dark:bg-zinc-800/50 rounded-smooth-md">
              ...
              <div class="flex items-center gap-2">
                <span class="text-[10px] px-2 py-0.5 rounded-full capitalize"
                  :class="member.role === 'owner' ? 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400' : 'bg-zinc-100 text-zinc-600 dark:bg-zinc-800 dark:text-zinc-400'">
                  {{ member.role }}
                </span>
                <button v-if="member.role !== 'owner'"
                  class="text-[10px] text-zinc-500 hover:text-red-600 dark:hover:text-red-400">
                  Remove
                </button>
              </div>
            </div>
          ...
          <div class="pt-2">
            <button
              class="flex items-center gap-1.5 px-3 py-1.5 text-xs bg-zinc-100 dark:bg-zinc-800 rounded-smooth-md hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-colors">
      ...
      <SettingsItem title="Team Plan" description="Manage your team subscription and limits.">
        <div class="space-y-3">
          <div class="p-3 bg-zinc-50 dark:bg-zinc-800/50 rounded-smooth-md">
            <div class="flex items-center justify-between mb-2">
              <p class="text-xs font-medium">Current Plan</p>
              <span class="text-xs font-semibold text-blue-600 dark:text-blue-400">Pro Team</span>
            </div>
            <p class="text-[10px] text-zinc-500 mb-3">5 team members • Unlimited videos • Priority encoding</p>

            <div class="space-y-2">
              <div class="flex justify-between text-[10px]">
                <span class="text-zinc-600 dark:text-zinc-400">Team members</span>
                <span>3 / 5</span>
              </div>
              <div class="flex justify-between text-[10px]">
                <span class="text-zinc-600 dark:text-zinc-400">Storage used</span>
                <span>124 GB / 500 GB</span>
              </div>
              <div class="flex justify-between text-[10px]">
                <span class="text-zinc-600 dark:text-zinc-400">Videos this month</span>
                <span>847</span>
              </div>
            </div>
          </div>
