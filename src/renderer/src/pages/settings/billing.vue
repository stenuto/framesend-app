  ...
  <div>
    ...
    <div v-else class="space-y-8 pt-8">
        ...
        <div class="p-3 bg-zinc-50 dark:bg-zinc-800/50 rounded-smooth-md">
          ...
          <div class="space-y-2">
            <div class="flex justify-between text-[10px]">
              <span class="text-zinc-600 dark:text-zinc-400">Next billing date</span>
      ...
      <SettingsItem title="Payment Method" description="Your default payment method.">
        <div class="space-y-3">
          <div class="flex items-center justify-between p-3 bg-zinc-50 dark:bg-zinc-800/50 rounded-smooth-md">
            <div class="flex items-center gap-3">
              <div class="w-10 h-6 bg-zinc-200 dark:bg-zinc-700 rounded flex items-center justify-center">
            ...
            <button class="text-[10px] text-zinc-500 hover:text-zinc-700 dark:hover:text-zinc-300">
              Update
            </button>
          </div>
        ...
        <div class="space-y-2">
          <div v-for="invoice in recentInvoices" :key="invoice.id" 
            ...
            <div class="text-right">
              ...
              <button class="text-[10px] text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300">
                Download
              </button>
            </div>
          </div>
          
          <button class="text-xs text-zinc-600 dark:text-zinc-400 hover:text-zinc-700 dark:hover:text-zinc-300 mt-2">
            View all invoices
          </button>
        </div>
      </SettingsItem>
