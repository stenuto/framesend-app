  ...
  <div class="aspect-video bg-zinc-900/50 relative overflow-hidden">
    ...
    <div v-else-if="items.length === 1" class="flex h-full">
      <div class="w-1/2 relative">
        <UnsplashImage :seed="items[0].id" :alt="`${items[0].name} thumbnail`" />
      </div>
